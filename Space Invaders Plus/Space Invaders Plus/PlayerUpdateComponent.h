...
{
private:
	string m_SpecificationType = "player";
...
public:
	...
	{
		m_TC = static_pointer_cast<TransformComponent>(self->getComponentByTypeAndSpecificationType("transform", "transform"));

		m_RCC = static_pointer_cast<RectColliderComponent>(self->getComponentByTypeAndSpecificationType("collider", "rect"));
	}
